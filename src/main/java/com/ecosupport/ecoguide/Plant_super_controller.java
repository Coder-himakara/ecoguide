...
public class Plant_super_controller {
    ...
    @FXML
    ChoiceBox<String> hab_status;
    String[] habitate = {"Wet zone", "Dry zone", "Arid zone", "Half-Arid zone", "None"};
    @FXML
    ChoiceBox<String> exp_status;
    String[] expansion = {"By Animals", "By Wind", "By Water", "None"};
    @FXML
    ChoiceBox<String> root_status;
    String[] root_system = {"Taproot", "Lateral roots", "Heart (oblique) roots", "None"};
    double pointerX;
    double pointerY;
    @FXML
